defmodule Practice.Traveller do
  ...
  defp get_address(address, :zipcode), do: split(address, :space) |> Enum.take(-2) |> Enum.join(" ")
  defp get_address(address, :street), do: split(address, :space) |> Enum.drop(1) |> Enum.drop(-2) |>  Enum.join(" ")
